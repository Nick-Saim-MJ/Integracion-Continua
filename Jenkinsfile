        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Nick-Saim-MJ/Integracion-Continua.git
            }
        }
        stage('Build') {
            steps {
